...
<div class="page-container">
    ...
    <div class="info">
        <h2 class="mt-4 section-title">Reports</h2>
        <a href="./add-report.php" class="add-btn">
        ...
        <div class="data-container">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php while ($request = mysqli_fetch_assoc($reports_result)) { ?>
                    <tr>
                        <td><?php echo htmlspecialchars($request['id']); ?></td>
                        <td><?php echo htmlspecialchars($request['student_id']); ?></td>
                        <td><?php echo htmlspecialchars($request['report_date']); ?></td>
