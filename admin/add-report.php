...
<div class="page-container">
    ...
    <div class="info">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-4 section-title">Add Report</h2>
                <a href="./admin_students.php.php" class="add-btn">
                    <i class="fas fa-plus fa-sm text-white-50"></i>Reports
                </a>
            </div>
        </div>
        <div class="data-container">
            ...
            <form action="submit_report.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="report_type" id="report_type" placeholder="e.g. Weekly, Final, Mid-Term" required>
                </div>
