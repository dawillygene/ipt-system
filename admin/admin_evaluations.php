...
$evaluations_sql = "SELECT * FROM evaluations";
$evaluations_result = mysqli_query($con, $evaluations_sql);
?>
...
<div class="page-container">
    ...
    <div class="info">
        <h2 class="mt-4 section-title">Evaluations</h2>
        <a href="./add-evaluation.php" class="add-btn">
            <i class="fas fa-plus fa-sm text-white-50"></i> Add Evaluation
        </a>
        <div class="data-container">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php while ($request = mysqli_fetch_assoc($evaluations_result)) { ?>
                    <tr>
                        <td><?php echo htmlspecialchars($request['id']); ?></td>
                        <td><?php echo htmlspecialchars($request['student_id']); ?></td>
                        <td><?php echo htmlspecialchars($request['supervisor_id']); ?></td>
                        <td><?php echo htmlspecialchars($request['comments']); ?></td>
                        <td><?php echo htmlspecialchars($request['evaluation_date']); ?></td>
                        <td><?php echo htmlspecialchars($request['evaluation_score']); ?></td>
                        <td>
