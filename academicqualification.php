        ...
        <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
          <nav class="menu__list">
            <ul class="nav navbar-nav menu__list">
              ...
              <li class="menu__item"><a href="index.phpt" class="menu__link scroll">Logout</a></li>
            </ul>
          </nav>
        </div>
      </nav>
...
<!--start left button-->
  ...
  <!--end left button-->
    ...
    <div class="partition" id="rightPartition">
        ...
        <form action="submit_qualifications.php" id="qualification-form" method="post" enctype="multipart/form-data">
            <div id="qualification-sections">
                <div class="qualification-section">
                    <label for="qualification_type">Qualification Type:</label>
                    <select id="qualification_type" name="qualifications[0][type]" required>
                    ...
                    <input type="text" id="institution" name="qualifications[0][institution]" required>
                    <label for="completion_year">Year of Completion:</label>
                    <input type="number" id="completion_year" name="qualifications[0][completion_year]" required min="1900" max="2024"><br>
                    <label for="document">Attach transcript:</label>
                    <input type="file" id="document" name="qualifications[0][document]" required><br>
                    <label for="documents">Attach certificate:</label>
                    <input type="file" id="documents" name="qualifications[0][documents]" required>
                </div>
            </div>
            <button type="button" id="add-qualification" onclick="addQualificationSection()">Add Qualification</button>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
      <div class="contact-agileits">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
            ...
            <p class="contact-agile1"><strong>Address :</strong> VUGA MJINI ZANZIBAR</p>
