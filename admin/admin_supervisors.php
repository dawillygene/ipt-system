...
$supervisors_sql = "SELECT supervisors.* FROM supervisors";
...
<head>
    ...
    <title>Admin Dashboard - supervisors</title>
...
<div class="page-container">
    ...
    <div class="info">
        <h2 class="mt-4 section-title">Supervisors</h2>
        <a href="./add-supervisor.php" class="add-btn">
            <i class="fas fa-plus fa-sm text-white-50"></i> Add Supervisor
        </a>
        <div class="data-container">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php while ($request = mysqli_fetch_assoc($supervisors_result)) { ?>
                    <tr>
