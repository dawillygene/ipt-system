...
$assignments_sql = "SELECT * FROM student_training_assignments";
...
<div class="page-container">
    ...
    <div class="info">
        <h2 class="mt-4 section-title">Training Assignments</h2>
        <a href="./add-training-assignment.php" class="add-btn">
            <i class="fas fa-plus fa-sm text-white-50"></i> Add Assignment
        </a>
        <div class="data-container">
            <table class="table table-bordered">
                ...
                <tbody>
                <?php while ($request = mysqli_fetch_assoc($assignments_result)) { ?>
                    <tr>
